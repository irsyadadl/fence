...
<body>
    <div class="antialiased flex items-center justify-center min-h-screen bg-gray-50 text-gray-800">
        <div class="lg:w-1/3 w-full">
            <div class="text-center mb-5">
                <div class="inline-flex items-center">
                    <svg class="w-12 h-12 text-gray-400" viewBox="0 0 364 364" fill="none" xmlns="http://www.w3.org/2000/svg">
